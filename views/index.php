            ...
            <div class="col-span-3">
                <ul class="list-none space-y-16 text-4xl">
                    <li class="flex items-start">
                        <img src="img/tick-icon.png" alt="Icon 1" class="mr-6 w-8 h-8">
                        <span>Ben je creatief en sta je het liefst in de keuken?</span>
                    </li>
                    <li class="flex items-start">
                        <img src="img/tick-icon.png" alt="Icon 2" class="mr-6 w-8 h-8">
                        <span>Ben je stressbestendig en hou je van samenwerken?</span>
                    </li>
                    <li class="flex items-start">
                        <img src="img/tick-icon.png" alt="Icon 3" class="mr-6 w-8 h-8">
                        <span>Ben je een aanpakker en vind je het niet erg om ’s avonds en in het weekend te werken?</span>
                    </li>
                </ul>
            </div>
