...
<body>
    ...
    <img id="koekje1" src="IMG/daniStuff/banner-1.jpg" class="imgbanner">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" id="container_1">
                ...
                <h1>
                    <hr> Chocolatier Academie Niveau 2 | BOL | 2-3 JR </hr>
                </h1>
                <h2>
                    <hr>Chocolatier Academie past bij jou </hr>
                </h2>
                ...
                <P>opleiding tot chocolatier jouw ultieme smaakvolle bestemming!</p>
                ...
                <p>en leert efficiënt voorraadbeheer. Verkoopgesprekken en het opbouwen</p>
                <p>van een klantenkring komen uitgebreid aan bod. Kortom, deze opleiding</p>
                <p>biedt een unieke kans om jouw passie voor chocolade om te zetten in </p>
                <p>een succesvolle onderneming.</p>
                <br>
                <br>
                <hr>
                <h3>wat ga je leren ?</h3>
                <hr>
                <h3>inhoud en vakken</h3>
                <hr>
                <h3>stagelopen</h3>
                <hr>
                <h3>versnellen of vertragen</h3>
                <hr>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6" id="container_3">
            <p>Niveau</p> <br>
            <p>2</p>
            <hr>
        </div>
    ...
    <div class="row">
        <div class="col-md-6" id="container_4">
            <p>Leerweg</p> <br>
            <p>BOL</p>
            <hr>
        </div>
    ...
    <img id="Div_3" src="IMG/AcademiaCookie2.png" alt="">
        ...
        <div class="col-md-6" id="container_6">
            ...
            <ul>
                <li>
                    <hr><br>
                    <p>Academie :</p>
                    <p id="li_2">Chocolatier Academie</p><br>
                    <hr><br>
                </li>
                <li>
                    <p>locatie :</p>
                    <p>Daltonlaan 300, Utrecht</p><br>
                    <hr><br>
                </li>
                <li>
                    <p>MHBO :</p>
                ...
                <li>
                    <p>versnellen :</p>
                    <p>Je kunt deze opleiding versneld afronden.</p><br>
                    <hr><br>
                </li>
                <li>
                    <p>kosten :</p>
